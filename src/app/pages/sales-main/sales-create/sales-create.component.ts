...
export class SalesCreateComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<SalesCreateComponent>, public service: SalesService, private catservice: CategoriesService
  ...
  onFormSubmit() {
    this.service.insertNewSales(this.humanResourcesAll, this.categeoriesALL).subscribe(
      mdata => {
        this.onClear();
        if (mdata != null)
